...
# We need to cast them all into a single matrix
...
for(i in seq(1,nrow(test))){
  ...
  # A train_mat matrix transposed will have the following shape
  #   |  cls1 | cls2 | cls3 |
  #-------------------------
  # w1 |   1   | 2  | 3 |
  # w2 |  2 | 3 |4 |
  # ....
  # So the test vector will minus each of the class keywords,
  # Resulting in a v(d) - v(c) for each class
  distance <- t(t(train_mat)-tmat)
  # Once we have the substraction, we proceed with exponential square
